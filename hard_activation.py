...
def main():
    atrain75 = pandas.read_csv('a75_random.csv', header=None)
    atrain25 = pandas.read_csv('a25_random.csv', header=None)
    btrain75 = pandas.read_csv('b75_random.csv', header=None)
    btrain25 = pandas.read_csv('b25_random.csv', header=None)
    ctrain75 = pandas.read_csv('randoma_c75.csv', header=None)
    ctrain25 = pandas.read_csv('randoma_c25.csv', header=None)
    ...
    for j in range(0, ni):
        ...
        if (j == 0 or error > ae):
            ...
            break
    calculate(a75, x, y, z, 'This is A75 for alpha ', alpha)
    ...
    for j in range(0, ni):
        if(j == 0 or error > ae):
           ...
           break
    calculate(a25, x, y, z, 'This is A25 for alpha ', alpha)
    print(j, '  error in a25', error)
    error = 0
    alpha = 0.4
    x = 0.4
    y = 0.5
    ...
    for j in range(0, ni):
        if (j == 0 or error > be):
            ...
            break
    calculate(b75, x, y, z, 'This is B75 for alpha ', alpha)
    print(j, '  error in b75', error)
    alpha = 0.1
    error = 0
    x = 0.2
    y = 0.3
    ...
    for j in range(0, ni):
        if (j == 0 or error > be):
            ...
            break
    calculate(b25, x, y, z, 'This is B25 for alpha ', alpha)
    print(j, '  error in b25', error)
    error = 0
    x = 0.5
    y = 0.2
    z = -0.1
    ...
    for j in range(0, ni):
        if j == 0 or error > ce:
            ...
            break
    calculate(c75, x, y, z, 'This is C75 for alpha ', alpha)
    print(j, '  error in c75', error)
    alpha = 0.3
    error = 0
    x = 0.2
    y = 0.3
    ...
    for j in range(0, ni):
        if j == 0 or error > ce:
            ...
            break
    calculate(c25, x, y, z, 'This is C25 for alpha ', alpha)
    print(j, '  error in c25', error)

def calculate(dataset, x, y, z, name, a):
